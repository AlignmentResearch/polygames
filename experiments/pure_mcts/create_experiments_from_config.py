...
def setup_game_and_save_command(
    ...
    directory_path = f"{EXPERIMENTS_DIRECTORY}/{game_name}/{dir_name}"
    ...
    commands.append(f'/bin/bash /polygames/experiments/memory_tracking.sh {directory_path}/memory.log &')
