...
def lg_connect(thelogin, thepassword):
    ...
    myresponse = requests.post(
        "https://www.littlegolem.net/jsp/login/index.jsp",
            ...
            try:
                ...
                if mygname == "Hex Size 11" and args.hex11_model:
                    (
                        ...
                        swapped,
                        last_action,
                    ) = hex_convert_hsgf_to_polygames(myhsgf)
                    ...
                    (
                        ...
                        swapped,
                        turn,
                    ) = breakthrough_convert_txt_to_polygames(myhsgf)
                    ...
                    (
                        ...
                        dice,
                        turn,
                    ) = einstein_convert_txt_to_polygames(myhsgf, mygid)
                ...
                if mygname == "Hex Size 11" or mygname == "Hex Size 13":
                    ...
                    if swapped:
                        x, y = (
                            y,
                            x,
                        )  # in littlegolem, swap is implemented by mirror move and not switching colors
