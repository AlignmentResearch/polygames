...
TEST(HexStateGroup, features_1) {
  ...
  std::vector<_Action> actions{{{0, -1, 1, 0},  // index, x, y, z
                                {0, -1, 0, 0}}};
...
TEST(HexStateGroup, features_2) {
  ...
  //   std::vector<_Action> actions{{{0, 1, 1, -1},
  //                                 {0, 0, 0, -1},
  //                                 {0, 2, 2, -1},
  //                                 {0, 2, 0, -1},
  //                                 {0, 1, 0, -1}}};
  ...
  std::vector<float> expectedFeatures{
      ...
      // history - 1, player 0
      0.f, 0.f, 0.f, 1.f, 1.f, 0.f, 0.f, 0.f, 1.f,
...
//       {{0, 0, 0, -1}, {0, 4, 1, -1}, {0, 2, 3, -1}, {0, 5, 2, -1},
//        {0, 2, 5, -1}, {0, 4, 4, -1}, {0, 2, 6, -1}, {0, 5, 5, -1},
//        {0, 7, 4, -1}, {0, 4, 7, -1}, {0, 7, 6, -1}, {0, 3, 8, -1},
//        {0, 5, 6, -1}, {0, 4, 6, -1}, {0, 4, 5, -1}, {0, 5, 4, -1},
//        {0, 5, 3, -1}, {0, 4, 3, -1}, {0, 4, 2, -1}, {0, 5, 1, -1},
//        {0, 5, 0, -1}, {0, 4, 0, -1}}};

  std::vector<_Action> actions{
      {{0, -1, 0, 0}, {0, -1, 4, 1}, {0, -1, 2, 3}, {0, -1, 5, 2},
       {0, -1, 2, 5}, {0, -1, 4, 4}, {0, -1, 2, 6}, {0, -1, 5, 5},
       {0, -1, 7, 4}, {0, -1, 4, 7}, {0, -1, 7, 6}, {0, -1, 3, 8},
       {0, -1, 5, 6}, {0, -1, 4, 6}, {0, -1, 4, 5}, {0, -1, 5, 4},
       {0, -1, 5, 3}, {0, -1, 4, 3}, {0, -1, 4, 2}, {0, -1, 5, 1},
       {0, -1, 5, 0}, {0, -1, 4, 0}}};
  ...
  ASSERT_EQ(
      (std::vector<int64_t>{nbChannels, size, size}), state.GetFeatureSize());

  std::vector<float> expectedFeatures{

      // history - 2, player 0
      1.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 1.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f,

      // history - 2, player 1
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 1.f, 0.f, 1.f, 1.f, 0.f, 1.f, 1.f, 0.f,
      0.f, 1.f, 1.f, 0.f, 1.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      ...
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 1.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f,
      1.f, 0.f, 0.f, 1.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      ...
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 1.f, 1.f, 0.f, 1.f, 1.f, 0.f, 1.f, 1.f, 0.f,
      0.f, 1.f, 1.f, 0.f, 1.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
  ...
  // std::cout << "*** actual ***" << std::endl;
  // printPlanes<std::vector<float>>(state.GetFeatures(), nbChannels, size,
  // size);
